...
const workflowDecisions = ["approve", "reject", "comment"] as const;
  ...
  try {
    ...
    await Promise.allSettled([
      ...
      logEdmsActivity({
        ...
        description: `${stepRecord.documentNumber} received a ${values.decision} decision at step ${stepRecord.stepNumber}.`,
        metadata: {
