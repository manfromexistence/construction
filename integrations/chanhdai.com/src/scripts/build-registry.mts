...
export const Index: Record<string, any> = {`;
  ...
  await fs.writeFile(path.join(REGISTRY_PATH, "registry.autogenerated.json"), registryJSON, "utf8");

  // Build public registry
  await rimraf(path.join(PUBLIC_REGISTRY_PATH, "registry.json"));
  await fs.writeFile(path.join(PUBLIC_REGISTRY_PATH, "registry.json"), registryJSON, "utf8");
