...
type MultiStepModalContentProps = React.CustomComponentPropsWithRef<typeof RadixDialog.Content> & {
  steps: MultiStepModalSteps[];
};

export function MultiStepModalContent({ steps, ...props }: MultiStepModalContentProps) {
