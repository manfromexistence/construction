      ...
      <div>
        ...
        <AnimateEnter delay={0.5} duration={2} className="mb-6 sm:mb-8">
          <p className="mx-auto max-w-lg text-[17px] sm:text-xl text-foreground">
            Library of copy and paste components to illuminate your applications with elegance and
            sophistication.
          </p>
        </AnimateEnter>
        <AnimateEnter
          ...
          duration={2}
        >
          <ButtonGlitch href="/ui/accordion">Explore components</ButtonGlitch>
          <GetStartedButton href="/ui/installation" />
        </AnimateEnter>
      </div>
      <AnimateEnter delay={0.9} duration={2} className="space-y-4">
        <h1 className="text-sm text-foreground/60 dark:text-foreground/80">Using</h1>
        <Techs />
      </AnimateEnter>
      <GridBackground />
    </div>
