...
import { AnimatePresence, type AnimationProps, MotionConfig, motion } from "motion/react";
...
export function InputOTP({ containerClassName, className, ...props }: InputOTPProps) {
  return (
    <OTPInput
      data-slot="input-otp"
