...
import { Field, FieldDescription, FieldTitle } from "@/styles/base-nova/ui-rtl/field";
  ...
  return (
    <Field dir={t.dir}>
      ...
      <FieldDescription>
        ...
        <span className="font-medium tabular-nums">{formatNumber(value[0], t.locale)}</span> -{" "}
        <span className="font-medium tabular-nums">{formatNumber(value[1], t.locale)}</span>
        ).
      </FieldDescription>
      <Slider
        value={value}
