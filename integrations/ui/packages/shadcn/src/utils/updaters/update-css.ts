...
export async function updateCss(
  ...
  const cssSpinner = spinner(`Updating ${highlighter.info(cssFilepathRelative)}`, {
...
export async function transformCss(input: string, css: z.infer<typeof registryItemCssSchema>) {
