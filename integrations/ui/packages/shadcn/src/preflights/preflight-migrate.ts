...
export async function preFlightMigrate(options: z.infer<typeof migrateOptionsSchema>) {
  ...
  try {
    ...
    logger.error(`Learn more at ${highlighter.info(`${SHADCN_URL}/docs/components-json`)}.`);
    logger.break();
    process.exit(1);
  }
}
