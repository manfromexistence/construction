...
describe("parseRegistryAndItemFromString", () => {
  describe("valid registry items", () => {
    it.each([
      ...
      ["@very-long-registry-name/item", { registry: "@very-long-registry-name", item: "item" }],
  ...
  describe("URLs and external paths", () => {
    it.each([
      ["https://example.com/button", { registry: null, item: "https://example.com/button" }],
      [
        "http://localhost:3000/component",
        { registry: null, item: "http://localhost:3000/component" },
      ],
      ["file:///path/to/component", { registry: null, item: "file:///path/to/component" }],
      ["ftp://example.com/file", { registry: null, item: "ftp://example.com/file" }],
      ["//cdn.example.com/component", { registry: null, item: "//cdn.example.com/component" }],
  ...
  describe("complex item paths", () => {
    it.each([
      ...
      ["@company/components/forms/input", { registry: "@company", item: "components/forms/input" }],
      [
  ...
  describe("registry names with special characters", () => {
    it.each([
      ["@my-registry/item", { registry: "@my-registry", item: "item" }],
      ["@my_registry/item", { registry: "@my_registry", item: "item" }],
      ["@my-registry-name/item", { registry: "@my-registry-name", item: "item" }],
      ["@my_registry_name/item", { registry: "@my_registry_name", item: "item" }],
      ["@my-registry_name/item", { registry: "@my-registry_name", item: "item" }],
      ["@my_registry-name/item", { registry: "@my_registry-name", item: "item" }],
