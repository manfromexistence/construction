...
import { BASE_COLORS, BUILTIN_REGISTRIES, REGISTRY_URL } from "@/src/registry/constants";
import { clearRegistryContext, setRegistryHeaders } from "@/src/registry/context";
import {
  ConfigParseError,
...
import { fetchRegistryItems, resolveRegistryTree } from "@/src/registry/resolver";
...
export async function getRegistriesConfig(cwd: string, options?: { useCache?: boolean }) {
