...
const FILES_NEEDING_MANUAL_REVIEW = ["sidebar.tsx", "pagination.tsx", "calendar.tsx"];

const RTL_DOCS_URL = `${SHADCN_URL}/docs/rtl#manual-migration-optional`;

export async function migrateRtl(config: Config, options: { yes?: boolean; path?: string } = {}) {
