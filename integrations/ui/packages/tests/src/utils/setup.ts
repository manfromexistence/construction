...
async function waitForCondition(label: string, check: () => Promise<boolean>, timeoutMs = 60000) {
...
export default async function setup() {
  ...
  await waitForCondition("shadcn CLI binary", () => fs.pathExists(SHADCN_CLI_PATH));
