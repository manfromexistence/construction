...
export async function GET(request: Request) {
  ...
  return new ImageResponse(
    <div tw="flex h-full w-full bg-white text-black" style={{ fontFamily: "Geist Sans" }}>
      ...
      {hasContent && (
        <div tw="flex absolute flex-row items-center justify-center bottom-24 right-24 text-white">
          ...
          <div tw="text-black flex text-[32px] font-semibold tracking-tight ml-2">Magic UI</div>
        </div>
      )}
        ...
        {hasContent ? (
          ...
          <div tw="flex flex-col items-center justify-center text-center w-full h-full">
            ...
            <div tw="text-gray-600 text-2xl flex">
              <p>Built with React, Typescript, shadcn/ui, Tailwind CSS, and Motion.</p>
            </div>
          </div>
        )}
      </div>
