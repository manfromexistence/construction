...
export interface NodeStaticWrapperComponentProps<C extends AnyPluginConfig = PluginConfig>
...
export interface RenderStaticNodeWrapperProps<C extends AnyPluginConfig = PluginConfig>
  extends SlateRenderElementProps<TElement, C> {
  key: string;
}
