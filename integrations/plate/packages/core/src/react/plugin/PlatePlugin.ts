...
export interface NodeWrapperComponentProps<C extends AnyPluginConfig = PluginConfig>
...
export interface RenderNodeWrapperProps<C extends AnyPluginConfig = PluginConfig>
  extends PlateElementProps<TElement, C> {
  key: string;
}
